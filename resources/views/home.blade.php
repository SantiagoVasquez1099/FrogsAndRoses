...
<div class="card">
    ...
    <em class="fa fa-tasks fa-lg mr-1"></em> {{ trans('global.reports') }} 
    </div>
    ...
    <div class="card-body">
        <table class="table table-bordered table-striped">
            <tbody>
                <tr>
                    <th>
                        <em class="fa fa-users fa-lg mr-1"></em>  {{ trans('global.users') }}
                    </th>
                    <td>
                       {{ $users }}
                    </td>
                ...
                <tr>
                    <th>
                        <em class="far fa-images fa-lg mr-1"></em>  {{ trans('global.images') }}
                    </th>
                    <td>
                        {{ $images }}
                    </td>
                ...
                <tr>
                    <th>
                        <em class="fa fa-boxes fa-lg mr-1"></em>  {{ trans('global.products') }}
                    </th>
                    <td>
                        {{ $products }}
                    </td>
...
<div class="card">
    <div class="card-header">
    <em class="fa fa-images fa-lg mr-1"></em> {{ trans('global.gallery') }}
    </div>

    <div class="card-body">
        <div class="col-12">
            <form accept-charset="UTF-8"
                action="{{ route('admin.gallery.uploadImage') }}"
                method="POST" enctype="multipart/form-data" class="dropzone hoverable" id="gallery_dropzone">
                <input type="hidden" id="url_images" name="url_images"
                    value="{{ route('admin.gallery.loadRowImages') }}" />
                {{ csrf_field() }}
            </form>
        </div>
        <div class="col-12">
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        try {
            var myDropzone = new Dropzone("#gallery_dropzone", {
                paramName: "image",
                maxFilesize: 30,
                addRemoveLinks: true,
